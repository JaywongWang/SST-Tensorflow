...
Extract C3D features for non-overlap 16-frame snippets from the 412 videos (200 *val* videos + 212 *test* videos, I found one *test* video missing) for the task of temporal action proposals. You may download my provided [C3D features](https://pan.baidu.com/s/1eTcIPDg), and put them in *dataset/thumos14/features/*.
